define(function(require){
    ...
    var Class             = require('common/Class'),
        ...
        ListChamberBase   = require('common/platform/chamber/ListChamberBase');
        ...
        ListChamberBase,
        {
            ...
            _handleBreadcrumb: function(descending) {
                if(this.moduleView._breadcrumb) {
                    var n = this.nestedListManager.getTreeNode();
                    var t = (n && n.text) || "";
